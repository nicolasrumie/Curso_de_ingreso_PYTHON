...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("El resultado de la suma es: ", int(operador_a) + int(operador_b))

    def btn_restar_on_click(self):
        operador_a = self.txt_operador_a.get()
        operador_b = self.txt_operador_b.get()
        alert("El resultado de la resta es: ", int(operador_a) - int(operador_b))

    def btn_multiplicar_on_click(self):
        operador_a = self.txt_operador_a.get()
        operador_b = self.txt_operador_b.get()
        alert("El resultado de la multiplicación es: ", int(operador_a) * int(operador_b))

    def btn_dividir_on_click(self):
        operador_a = self.txt_operador_a.get()
        operador_b = self.txt_operador_b.get()
        alert("El resultado de la división es: ", int(operador_a) / int(operador_b))
